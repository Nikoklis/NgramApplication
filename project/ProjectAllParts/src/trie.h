...
public:
  ...
  void Work(int queryFilePosition, Trie_Node **&N_GramMatrix, char **argv, BloomFilter *&blF, Heap &heap);

  void Init_And_Work(int inputFilePosition, int queryFilePosition, Trie_Node **&, Trie_Node **&, char **argv, BloomFilter *&, Heap &);
  void TEST_FUNCTIONS();
};
